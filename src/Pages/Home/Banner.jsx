        ...
        <div className="absolute flex items-center w-full h-full transform  md:left-0  md:top-0 bg-black bg-opacity-40">
          <div className="md:space-y-6  md:pt-5 pt-28 md:pl-12">
            ...
            <p className="text-white md:text-center mb-4 ml-4 md:w-1/2 md:ml-72 md:text-xl text-base md:font-bold ">
              The Weight Loss Academy brings you the most sought that teaches
              you how to lose body fat, gain confidence, increase energy and
              create a healthier relationship with food
            </p>
            <button className="btn bg-[#de6d72]  btn-primary  text-white border-0 md:btn-wide md:ml-[450px] ml-4 md:rounded-full">
              Join Us
            </button>
          </div>
        </div>
