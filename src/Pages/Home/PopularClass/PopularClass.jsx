...
const PopularClass = () => {
    ...
    return (
        <div className='mt-40'>
           ...
           <div className='grid grid-cols-1 md:grid-cols-3 gap-4 md:mx-20 mx-6 mt-10' >
           {
                popular.map(popularClass=>
                    <div key={popularClass._id} className="card w-80 bg-base-100 shadow-xl">
                    <figure><img src={popularClass.classImage} alt="class" /></figure>
